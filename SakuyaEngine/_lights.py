    ...
    def surface(self) -> pygame.Surface:
        ...
        for out_surf in self.outer_light_surfs:
            ...
            if "surf" in out_surf_keys:
                ...
                color_surf = pygame.Surface(self._screen.get_size()).convert_alpha()
                color_surf.fill((0, 0, 0, 0))
                color_surf.blit(out_surf["color_surf"], out_surf["position"])
